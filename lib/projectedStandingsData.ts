// lib/projectedStandingsData.ts

export const seasonColumns = [
  { label: "2026", key: "y2026" },
  { label: "2027", key: "y2027" },
  { label: "2028", key: "y2028" },
  { label: "2029", key: "y2029" },
  { label: "2030", key: "y2030" },
  { label: "2031", key: "y2031" },
  { label: "2032", key: "y2032" },
] as const;

export type SeasonKey = (typeof seasonColumns)[number]["key"];
...
export const confidences = [95, 90, 82, 74, 66, 58, 50];
